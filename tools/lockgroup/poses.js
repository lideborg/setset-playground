...
const POSE_PROMPTS = {
    ...
    'pose-pdp-halfbody': [
        'Waist-up portrait of this exact person in white studio. Shoulders squared, hands at sides, direct gaze. [PRODUCT_DESCRIPTION]. [LIGHTING]. Keep identical facial features.',
        'Half-body portrait of this exact person in white studio. From waist up, shoulders back, looking at camera. [PRODUCT_DESCRIPTION]. [LIGHTING]. Maintain exact face.',
        'Waist-up portrait of this exact person in white studio. Squared shoulders, confident gaze into camera. [PRODUCT_DESCRIPTION]. [LIGHTING]. Preserve facial identity.',
    ],
    'pose-pdp-closer': [
